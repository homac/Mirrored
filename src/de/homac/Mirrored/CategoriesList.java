...
public class CategoriesList extends ListActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        ArrayAdapter<String> notes = new ArrayAdapter<String>(this, R.layout.category_row, R.id.category_name, Arrays.asList(_categories));
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        String category = l.getAdapter().getItem(position).toString().toLowerCase();
        if (MDebug.LOG)
